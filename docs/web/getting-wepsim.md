...
WepSIM can be installed on iOS, Android, Windows, Linux, etc. as a Progressive Web Application.

To install WepSIM as a Progressive Web Application (PWA), please follow these steps:
